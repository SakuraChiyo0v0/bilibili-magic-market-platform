    ...
    <Card title="爬虫配置">
      <Form form={form} layout="vertical" onFinish={onFinish}>
        ...
        <Form.Item
          ...
          extra="关闭图片加载可以节省流量并提高页面流畅度。"
        >
          <Switch checkedChildren="开启" unCheckedChildren="关闭" />
        </Form.Item>

        <Divider orientation="left">身份认证</Divider>
        <Form.Item
          name="user_cookie"
        ...
        <Divider orientation="left">频率控制</Divider>
        <Form.Item
          name="request_interval"
          label="请求间隔 (秒)"
          extra="每次向 Bilibili 发送 HTTP 请求之间的等待时间。如果遇到 IP 封禁，请增加此值。"
        ...
        <Form.Item
          ...
          label="价格区间"
        >
          <Checkbox.Group options={priceOptions} />
        </Form.Item>
